        ...
        <footer className="bg-[#4B9795] text-white py-8 px-4 border-t border-gray-200">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row gap-8 mb-8">
                            ...
                            <div className="flex flex-wrap gap-4">
                                {navItems.map((item, index) => (
                                    <a 
                                        key={`nav-${index}`} 
                                        href="#" 
                                        className="2xl:text-[20px] md:text-lg hover:underline"
                                    >
                                        {item.label}
                                    </a>
                                ))}
                    ...
                    <div className="md:w-1/2 flex flex-col items-center md:items-end">
                        <div className="text-center md:text-right mb-6">
                            <h2 className="text-2xl md:text-3xl 2xl:text-5xl font-semibold mb-2">Delivering On Promises,</h2>
                            <h2 className="text-2xl md:text-3xl 2xl:text-5xl font-semibold">Powered by Precision</h2>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <nav className="md:mt-[4rem] md:col-span-5 flex flex-wrap justify-center gap-4 whitespace-nowrap" aria-label="Support navigation">
                        {supportItems.map((item, index) => (
                            <a 
                                key={`support-${index}`} 
                                href="#" 
                                className="2xl:text-[20px] text-sm hover:underline"
                            >
                                {item.label}
                            </a>
                        ))}

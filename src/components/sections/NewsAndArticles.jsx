    ...
    return (
        <section className="py-16">
            <div className="container mx-auto px-4">
                <header className="text-center mb-12"> {/* Added semantic header */}
                ...
                <div className="2xl:mt-24 flex flex-col md:flex-row      lg:flex-row gap-8">
                    <div className="md:w-1/2">
                        ...
                        />
                        <div className="py-4">
                            <span className="text-sm 2xl:text[20px] text-gray-500">July 4, 2025</span>
                            ...
                            <Button variant="link" icon={<FaArrowRight />}>Read more</Button>
                        </div>
                    </div>
                        ...
                        {articles.map((article, index) => (
                            ...
                            >
                                ...
                                <div className="px-4 py-1 flex flex-col justify-between items-start w-3/4"> 
                                    <div>
                                        <span className="text-xs 2xl:text-[20px] text-gray-500">{article.date}</span>
                                        <h3 className="text-md 2xl:text-[24px] font-semibold mt-1 mb-2 text-gray-800 line-clamp-2">
                                            {article.title}
                                        </h3>
                                    </div>
                                    <Button variant="link" icon={<FaArrowRight />} className="!justify-start">Read more</Button>
                                </div>
                            </Card>
                        ))}
                    </div>

    ...
    return (
        <div className='py-52'>
            <div className="container mx-auto px-2 py-2 items-center justify-between w-full">
                <div>
                    <h2 className="text-4xl md:text-3xl font-bold text-center text-[#4B9795]"><span className="text-black">What</span> People & Businesses 
                        <br/>
                     <span className="text-black">Say About Our</span>  Services</h2>
                </div>
                <div className="flex flex-col mt-6   md:flex-row gap-8 justify-center">
                    {feedbacks.map((feedback, index) => (
                        <div
                            key={index}
                            className="bg-white p-6 rounded-lg border border-[#4B9795] flex flex-col md:flex-row w-full md:w-[45%]"
                        >

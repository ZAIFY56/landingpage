    ...
    <section className="">
      <div className="container mx-auto px-2 py-2 flex flex-col-reverse md:flex-row">
        <div className="md:w-1/2">
          <h1 className="text-xl md:text-3xl text-center md:text-start font-bold mb-6">Our <span className='text-[#4B9795]'>Mission</span></h1>
          <div className="space-y-4 text-sm md:text-md relative">
            ...
            <img
              src={image1}
              alt="our mission"
              className="md:absolute dark:filter dark:grayscale border-8 rounded border-[#F3F3F3] top-56 left-20 w-[100%] h-[18rem] z-50 object-cover"
            />
          </div>
        </div>
        <div className="md:w-1/2">
          <h1 className="text-xl md:text-3xl text-center md:text-start font-bold mb-6">Our <span className='text-[#4B9795]'>Vision</span></h1>

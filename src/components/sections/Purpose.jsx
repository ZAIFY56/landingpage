      ...
      <div className="container mx-auto px-2 py-2 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          ...
          <div className="space-y-4 text-sm md:text-md">
            <p className="mx-auto text-center md:text-start 2xl:text-[20px] pr-12">
            To become the UK’s most trusted and efficient courier service, setting the standard for speed, security, and reliability — delivering peace of mind to every doorstep, on time, every time.            </p>
            <img
              src={image2}
